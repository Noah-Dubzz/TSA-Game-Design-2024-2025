function unit_attacker_step() {
    ...
    // Check if it's the target's turn (if not, skip movement logic)
    if (global.currentturn == target) {
        ...
        if (owner == objP1) {
            if (global.p1character == 1) {
                if (type == "Attacker") {
                    sprite_index = sprBlUnit2; // Player 1, Attacker sprite
                }
                if (type == "Gatherer") {
                    sprite_index = sprBlUnit1; // Player 1, Gatherer sprite
                }
            }
            ...
            if (global.p1character == 3) {
                if (type == "Attacker") {
                    sprite_index = sprAXUnit2; // Player 1, Attacker sprite
                }
                if (type == "Gatherer") {
                    sprite_index = sprAXUnit1; // Player 1, Gatherer sprite
                }
            }
            if (global.p1character == 4) {
                if (type == "Attacker") {
                    sprite_index = sprWRUnit2; // Player 1, Attacker sprite
                }
                if (type == "Gatherer") {
                    sprite_index = sprWRUnit1; // Player 1, Gatherer sprite
                }
            }
        }
