...
xOffset = -130;  // Offset from the right edge of the screen (move it to the left by 100 pixels)
yOffset = -75;   // Offset from the bottom edge of the screen (move it up by 50 pixels)
